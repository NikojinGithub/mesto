//Класс содержит функции отвечающие  за открытие и закрытие попапов, содержит отдельные функции для описания функциональсти
//закрытия попапа по нажатию esc и клику мими попапа.
